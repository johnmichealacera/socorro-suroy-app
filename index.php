    ...
    <div class="container-fluid page-header py-5">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase text-center px-2">Whole Map of Socorro</h3>
                <p class="text-white-50 text-center small mb-3 px-3" style="max-width: 560px;">Use the map to get your bearings. For a partial, immersive 3D view of the island terrain, open the experience below (loads in a new tab).</p>
                <div class="embed-responsive embed-responsive-4by3 mt-2 w-100" style="max-width: 720px;">
                    <iframe title="Map of Socorro, Surigao del Norte" class="embed-responsive-item" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d125863.41631899662!2d125.8561945658465!3d9.661228383191364!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3303e3b1411a3e55%3A0x3ee789b24f4e50dd!2sSocorro%2C%20Surigao%20del%20Norte!5e0!3m2!1sen!2sph!4v1719115759210!5m2!1sen!2sph" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="text-center mt-4">
                    <a href="https://socorro3d.johnmichealacera.com/" class="btn btn-outline-light" target="_blank" rel="noopener noreferrer">
                        <i class="fa fa-cube mr-2" aria-hidden="true"></i>Open 3D interactive map
                    </a>
                </div>
            </div>
        </div>
